...
def init_arg():
    ...
    my_group.add_argument('-t', '--tencent', action='store_true', default=True, help='tencent cloud')
    my_group.add_argument('-a', '--alibaba', action='store_true', help='alibaba cloud')
    
    parser.add_argument('-p', '--proxy',  action='store', default=None, type=int, help ='local HTTP proxy port')
